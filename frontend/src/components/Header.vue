      ...
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center">
          <router-link to="/" class="flex items-center space-x-2">
            <div class="w-8 h-8 bg-gradient-to-br from-amber-500 to-red-600 rounded-lg flex items-center justify-center">
        ...
        <nav class="hidden md:flex items-center space-x-1">
          <router-link
            ...
            :class="isActive(item.path) ? 'bg-amber-50 text-amber-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'"
          >
            {{ item.name }}
          </router-link>
        </nav>
    ...
    <div class="md:hidden border-t border-gray-100">
      <div class="flex">
        <router-link
          ...
          :class="isActive(item.path) ? 'text-amber-700 border-b-2 border-amber-500' : 'text-gray-500'"
        >
          {{ item.name }}
        </router-link>
      </div>
